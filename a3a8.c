...
void A3A8(unsigned char rand[16], unsigned char key[16], unsigned char simoutput[12]);

static const unsigned char table_0[512] =
{
        102, 177, 186,162,   2, 156, 112, 75,
         55,  25,   8, 12, 251, 193, 246,188,
...
void A3A8(Byte rand[16], Byte key[16],
...
int main(int argc, char **argv)
{
    ...
    for (i=0; i<16; i++)
        	key[i] = (hextoint(argv[1]
        [2*i+2])<<4) | hextoint(argv[1][2*i+3]);
	for (i=0; i<16; i++)
